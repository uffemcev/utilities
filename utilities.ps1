<#
	...
	Set-ExecutionPolicy Bypass -Scope Process -Force; &{. .\utilities.ps1; manual}
	...
	Set-ExecutionPolicy Bypass -Scope Process -Force; &{. .\utilities.ps1; auto -store -office -chrome}
	...
	Set-ExecutionPolicy Bypass -Scope Process -Force; &{. .\utilities.ps1; auto -all}
#>
function manual
{
