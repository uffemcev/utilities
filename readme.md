...
Скрипт для установки компонентов и программ через winget.

Присутствует удобный консольный интерфейс, группировка по категориям, поиск по словам, параметры для автоматической установки. По возможности устанавливаются последние версии программ в тихом режиме. Cкрипт проверен на Windows 11 24H2.
	...
	<table>
		...
		<tbody>
			...
			<tr>
				<td>other</td>
				<td>win</td>
				<td><a href="https://uupdump.net/">Win 11 25H2 iso</a></td>
			</tr>
			<tr>
				<td>other</td>
				<td>rufus</td>
